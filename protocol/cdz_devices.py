...
from protocol.cdz_ptotocol import CDZ_Protocol
...
class CDZ_Dev(BaseSim):
    def __init__(self, logger, config_file, server_addr, N=0, tt=None, encrypt_flag=0, self_addr=None):
        ...
        module_name = "protocol.config.CDZ.%s" % config_file
        ...
        self.sdk_obj = CDZ_Protocol(logger=logger, addr=server_addr, self_addr=self_addr)
